defmodule Angio.CongenitalsTest do
  ...
  describe "chd_care_episodes" do
    ...
    test "create_chd_care_episode/1 with valid data creates a chd_care_episode" do
      assert {:ok, %Chd_care_episode{} = chd_care_episode} =
               Congenitals.create_chd_care_episode(@valid_attrs)
    ...
    test "update_chd_care_episode/2 with valid data updates the chd_care_episode" do
      ...
      assert {:ok, %Chd_care_episode{} = chd_care_episode} =
               Congenitals.update_chd_care_episode(chd_care_episode, @update_attrs)
      ...
      assert chd_care_episode.chd_cath_proc_recent_2_id ==
               "some updated chd_cath_proc_recent_2_id"

      assert chd_care_episode.chd_cath_proc_recent_3_id ==
               "some updated chd_cath_proc_recent_3_id"

      assert chd_care_episode.chd_cath_proc_recent_4_id ==
               "some updated chd_cath_proc_recent_4_id"
    ...
    test "update_chd_care_episode/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Congenitals.update_chd_care_episode(chd_care_episode, @invalid_attrs)
    ...
    test "delete_chd_care_episode/1 deletes the chd_care_episode" do
      ...
      assert_raise Ecto.NoResultsError, fn ->
        Congenitals.get_chd_care_episode!(chd_care_episode.id)
      end
    end
  ...
  describe "chd_conditions" do
    ...
    test "create_chd_condition/1 with valid data creates a chd_condition" do
      assert {:ok, %Chd_condition{} = chd_condition} =
               Congenitals.create_chd_condition(@valid_attrs)
    ...
    test "update_chd_condition/2 with valid data updates the chd_condition" do
      ...
      assert {:ok, %Chd_condition{} = chd_condition} =
               Congenitals.update_chd_condition(chd_condition, @update_attrs)
    ...
    test "update_chd_condition/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Congenitals.update_chd_condition(chd_condition, @invalid_attrs)
  ...
  describe "chd_risk_factors" do
    ...
    @valid_attrs %{
      ...
      chd_cardiomyopathy_history: "some chd_cardiomyopathy_history",
      chd_cardiomyopathy_yn: true,
      chd_chronic_lung_disease_yn: true,
      chd_coagulation_disorder_yn: true,
      chd_diabetes_yn: true,
      chd_endocarditis_yn: true,
      chd_heart_transplant_yn: true,
      chd_hepatic_disease_yn: true,
      chd_hf_1_month_yn: true,
      chd_hyper_coagulable_state_yn: true,
      chd_hypo_coagulable_state_yn: true,
      chd_ischemic_heart_disease_yn: true,
      chd_kawasaki_yn: true,
      chd_nyha: "some chd_nyha",
      chd_renal_insufficiency_yn: true,
      chd_rheumatic_heart_disease_yn: true,
      chd_risk_factors_notes: "some chd_risk_factors_notes",
      chd_seizure_disorder_yn: true,
      chd_sickle_cell_anemia_yn: true,
      chd_stroke_prior_yn: true
    }
    @update_attrs %{
      chd_arrhythmia_history: [],
      chd_cardiomyopathy_history: "some updated chd_cardiomyopathy_history",
      chd_cardiomyopathy_yn: false,
      chd_chronic_lung_disease_yn: false,
      chd_coagulation_disorder_yn: false,
      chd_diabetes_yn: false,
      chd_endocarditis_yn: false,
      chd_heart_transplant_yn: false,
      chd_hepatic_disease_yn: false,
      chd_hf_1_month_yn: false,
      chd_hyper_coagulable_state_yn: false,
      chd_hypo_coagulable_state_yn: false,
      chd_ischemic_heart_disease_yn: false,
      chd_kawasaki_yn: false,
      chd_nyha: "some updated chd_nyha",
      chd_renal_insufficiency_yn: false,
      chd_rheumatic_heart_disease_yn: false,
      chd_risk_factors_notes: "some updated chd_risk_factors_notes",
      chd_seizure_disorder_yn: false,
      chd_sickle_cell_anemia_yn: false,
      chd_stroke_prior_yn: false
    }
    @invalid_attrs %{
      chd_arrhythmia_history: nil,
      chd_cardiomyopathy_history: nil,
      chd_cardiomyopathy_yn: nil,
      chd_chronic_lung_disease_yn: nil,
      chd_coagulation_disorder_yn: nil,
      chd_diabetes_yn: nil,
      chd_endocarditis_yn: nil,
      chd_heart_transplant_yn: nil,
      chd_hepatic_disease_yn: nil,
      chd_hf_1_month_yn: nil,
      chd_hyper_coagulable_state_yn: nil,
      chd_hypo_coagulable_state_yn: nil,
      chd_ischemic_heart_disease_yn: nil,
      chd_kawasaki_yn: nil,
      chd_nyha: nil,
      chd_renal_insufficiency_yn: nil,
      chd_rheumatic_heart_disease_yn: nil,
      chd_risk_factors_notes: nil,
      chd_seizure_disorder_yn: nil,
      chd_sickle_cell_anemia_yn: nil,
      chd_stroke_prior_yn: nil
    }
    ...
    test "create_chd_risk_factor/1 with valid data creates a chd_risk_factor" do
      assert {:ok, %Chd_risk_factor{} = chd_risk_factor} =
               Congenitals.create_chd_risk_factor(@valid_attrs)
    ...
    test "update_chd_risk_factor/2 with valid data updates the chd_risk_factor" do
      ...
      assert {:ok, %Chd_risk_factor{} = chd_risk_factor} =
               Congenitals.update_chd_risk_factor(chd_risk_factor, @update_attrs)

      assert chd_risk_factor.chd_arrhythmia_history == []

      assert chd_risk_factor.chd_cardiomyopathy_history ==
               "some updated chd_cardiomyopathy_history"
    ...
    test "update_chd_risk_factor/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Congenitals.update_chd_risk_factor(chd_risk_factor, @invalid_attrs)
    ...
    test "delete_chd_risk_factor/1 deletes the chd_risk_factor" do
      ...
      assert_raise Ecto.NoResultsError, fn ->
        Congenitals.get_chd_risk_factor!(chd_risk_factor.id)
      end
    end
