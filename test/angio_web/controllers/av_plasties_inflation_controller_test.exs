defmodule AngioWeb.Av_plasties_inflationControllerTest do
  ...
  @create_attrs %{
    avp_bal_outcome: "some avp_bal_outcome",
    avpi_av_reg_degree_post: "some avpi_av_reg_degree_post",
    avpi_balloon_technique: "some avpi_balloon_technique",
    avpi_db_bal_2_id: "some avpi_db_bal_2_id",
    avpi_inflation_counter: "some avpi_inflation_counter",
    avpi_max_inflation_pres: "some avpi_max_inflation_pres",
    avpi_notes: "some avpi_notes",
    avpi_peak_sys_gradient_post: "some avpi_peak_sys_gradient_post",
    avpi_sb_bal_1_id: "some avpi_sb_bal_1_id",
    avpi_stabilization_yn: true
  }
  @update_attrs %{
    avp_bal_outcome: "some updated avp_bal_outcome",
    avpi_av_reg_degree_post: "some updated avpi_av_reg_degree_post",
    avpi_balloon_technique: "some updated avpi_balloon_technique",
    avpi_db_bal_2_id: "some updated avpi_db_bal_2_id",
    avpi_inflation_counter: "some updated avpi_inflation_counter",
    avpi_max_inflation_pres: "some updated avpi_max_inflation_pres",
    avpi_notes: "some updated avpi_notes",
    avpi_peak_sys_gradient_post: "some updated avpi_peak_sys_gradient_post",
    avpi_sb_bal_1_id: "some updated avpi_sb_bal_1_id",
    avpi_stabilization_yn: false
  }
  @invalid_attrs %{
    avp_bal_outcome: nil,
    avpi_av_reg_degree_post: nil,
    avpi_balloon_technique: nil,
    avpi_db_bal_2_id: nil,
    avpi_inflation_counter: nil,
    avpi_max_inflation_pres: nil,
    avpi_notes: nil,
    avpi_peak_sys_gradient_post: nil,
    avpi_sb_bal_1_id: nil,
    avpi_stabilization_yn: nil
  }
  ...
  describe "create av_plasties_inflation" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn =
        post(conn, Routes.av_plasties_inflation_path(conn, :create),
          av_plasties_inflation: @create_attrs
        )
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(conn, Routes.av_plasties_inflation_path(conn, :create),
          av_plasties_inflation: @invalid_attrs
        )
  ...
  describe "edit av_plasties_inflation" do
    ...
    test "renders form for editing chosen av_plasties_inflation", %{
      conn: conn,
  ...
  describe "update av_plasties_inflation" do
    ...
    test "redirects when data is valid", %{
      ...
      conn =
        put(conn, Routes.av_plasties_inflation_path(conn, :update, av_plasties_inflation),
          av_plasties_inflation: @update_attrs
        )

      assert redirected_to(conn) ==
               Routes.av_plasties_inflation_path(conn, :show, av_plasties_inflation)
  ...
  describe "delete av_plasties_inflation" do
    ...
    test "deletes chosen av_plasties_inflation", %{
      conn: conn,
      av_plasties_inflation: av_plasties_inflation
    } do
