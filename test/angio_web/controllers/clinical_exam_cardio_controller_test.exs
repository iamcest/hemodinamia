defmodule AngioWeb.Clinical_exam_cardioControllerTest do
  ...
  describe "create clinical_exam_cardio" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn =
        post(conn, Routes.clinical_exam_cardio_path(conn, :create),
          clinical_exam_cardio: @create_attrs
        )
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(conn, Routes.clinical_exam_cardio_path(conn, :create),
          clinical_exam_cardio: @invalid_attrs
        )
  ...
  describe "edit clinical_exam_cardio" do
    ...
    test "renders form for editing chosen clinical_exam_cardio", %{
      conn: conn,
      clinical_exam_cardio: clinical_exam_cardio
    } do
  ...
  describe "update clinical_exam_cardio" do
    ...
    test "redirects when data is valid", %{conn: conn, clinical_exam_cardio: clinical_exam_cardio} do
      conn =
        put(conn, Routes.clinical_exam_cardio_path(conn, :update, clinical_exam_cardio),
          clinical_exam_cardio: @update_attrs
        )

      assert redirected_to(conn) ==
               Routes.clinical_exam_cardio_path(conn, :show, clinical_exam_cardio)
  ...
  describe "delete clinical_exam_cardio" do
    ...
    test "deletes chosen clinical_exam_cardio", %{
      conn: conn,
      clinical_exam_cardio: clinical_exam_cardio
    } do
