defmodule AngioWeb.Echo_right_atriumControllerTest do
  ...
  describe "create echo_right_atrium" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn = post(conn, Routes.echo_right_atrium_path(conn, :create), echo_right_atrium: @create_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn = post(conn, Routes.echo_right_atrium_path(conn, :create), echo_right_atrium: @invalid_attrs)
      assert html_response(conn, 200) =~ "New Echo right atrium"
    end
  end
  ...
  describe "edit echo_right_atrium" do
    ...
    test "renders form for editing chosen echo_right_atrium", %{conn: conn, echo_right_atrium: echo_right_atrium} do
  ...
  describe "update echo_right_atrium" do
    ...
    test "redirects when data is valid", %{conn: conn, echo_right_atrium: echo_right_atrium} do
      conn = put(conn, Routes.echo_right_atrium_path(conn, :update, echo_right_atrium), echo_right_atrium: @update_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn, echo_right_atrium: echo_right_atrium} do
      conn = put(conn, Routes.echo_right_atrium_path(conn, :update, echo_right_atrium), echo_right_atrium: @invalid_attrs)
      assert html_response(conn, 200) =~ "Edit Echo right atrium"
    end
  end
