defmodule Angio.Interventions.Av_plasty do
  ...
  def changeset(av_plasty, attrs) do
    av_plasty
    |> cast(attrs, [:avp_dt, :avp_tm, :avp_operator_lname, :avp_operator_fname, :avp_operator_mname, :avp_operator_npi, :avp_primary_indication, :avp_av_morphology, :avp_av_reg_degree_pre, :avp_av_ann_diam_us, :avp_peak_sys_gradient_pre, :avp_notes])
    |> validate_required([])
