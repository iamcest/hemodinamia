defmodule Angio.Ivestigations.Echo_left_atrium do
  ...
  def changeset(echo_left_atrium, attrs) do
    ...
    |> cast(attrs, [
      :ela_volume_val,
      :ela_chatheter_loc_desc,
      :ela_volume_desc,
      :ela_diam_si_val,
      :ela_volume_index,
      :ela_diam_ml_val,
      :ela_appearance_trasplantation_yn,
      :ela_mas_location_desc,
      :ela_cor_triatrium_yn,
      :ela_asd_yn,
      :ela_pum_veins_thrombus_tumour_yn,
      :ela_chatheter_yn,
      :ela_area_4ch_2d_us,
      :ela_spontaneous_contrast_yn,
      :ela_thromus_tumour_body_loc,
      :ela_mas_attachment_site,
      :ela_volume_method,
      :ela_mas_yn,
      :ela_spontaneous_contrast_persist,
      :ela_diam_ap_val,
      :ela_spontaneous_contrast_loc,
      :ela_notes
    ])
    |> validate_required([])
